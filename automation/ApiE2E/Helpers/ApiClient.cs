...
public sealed class ApiClient
{
    ...
    public ApiClient(string baseUrl, string? hostHeader = null)
    {
        ...
        if (!string.IsNullOrWhiteSpace(hostHeader))
            _http.DefaultRequestHeaders.Host = hostHeader;
    }
    ...
    public Task<(HttpStatusCode Status, JsonDocument Body)> GetAsync(string route)
