...
public static class DatabaseSeeder
{
    public static async Task SeedAsync(ConnectedCareDbContext context)
    {
        ...
        // 2b. Seed Patients (Matching Image 17)
        if (!await context.Patients.AnyAsync())
        {
            var seededPatients = new List<Patient>
            {
                new Patient { PatientIdCode = "P-0001", Name = "Robert Johnson", Dob = "Oct 12, 1956", AgeGender = "67 / Male", Phone = "(512) 555-2458", CareUnit = "Cardiology Unit", FloorRoom = "3rd Floor - 301", PrimaryDoctorName = "Dr. Sarah Wilson", PrimaryDoctorSpecialty = "Emergency Medicine", Status = PatientStatus.InCare, RiskLevel = AlertSeverity.High, LastVisit = "May 20, 2024 10:15 AM", Avatar = "https://images.unsplash.com/photo-1622253692010-333f2da6031d?w=150&auto=format&fit=crop&q=80" },
                new Patient { PatientIdCode = "P-0002", Name = "Patricia Smith", Dob = "Mar 23, 1948", AgeGender = "76 / Female", Phone = "(512) 555-8765", CareUnit = "Med-Surg Unit 2", FloorRoom = "2nd Floor - 202", PrimaryDoctorName = "Dr. Michael Brown", PrimaryDoctorSpecialty = "Cardiology", Status = PatientStatus.InCare, RiskLevel = AlertSeverity.High, LastVisit = "May 20, 2024 09:45 AM", Avatar = "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150&auto=format&fit=crop&q=80" },
                new Patient { PatientIdCode = "P-0003", Name = "Michael Davis", Dob = "Jul 08, 1963", AgeGender = "60 / Male", Phone = "(512) 555-1122", CareUnit = "Med-Surg Unit 2", FloorRoom = "2nd Floor - 205", PrimaryDoctorName = "Dr. James Lee", PrimaryDoctorSpecialty = "Orthopedics", Status = PatientStatus.Admitted, RiskLevel = AlertSeverity.Medium, LastVisit = "May 20, 2024 08:30 AM", Avatar = "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80" },
                new Patient { PatientIdCode = "P-0004", Name = "Linda Martinez", Dob = "Feb 17, 1955", AgeGender = "69 / Female", Phone = "(512) 555-3344", CareUnit = "Diabetes Care", FloorRoom = "1st Floor - 104", PrimaryDoctorName = "Dr. Emily Clark", PrimaryDoctorSpecialty = "Endocrinology", Status = PatientStatus.InCare, RiskLevel = AlertSeverity.Medium, LastVisit = "May 19, 2024 04:20 PM", Avatar = "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&auto=format&fit=crop&q=80" },
                new Patient { PatientIdCode = "P-0005", Name = "James Brown", Dob = "Jan 05, 1959", AgeGender = "65 / Male", Phone = "(512) 555-6677", CareUnit = "General Ward", FloorRoom = "1st Floor - 110", PrimaryDoctorName = "Dr. Sarah Wilson", PrimaryDoctorSpecialty = "Emergency Medicine", Status = PatientStatus.Admitted, RiskLevel = AlertSeverity.High, LastVisit = "May 19, 2024 02:10 PM", Avatar = "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80" },
                new Patient { PatientIdCode = "P-0006", Name = "Mary Williams", Dob = "Apr 30, 1942", AgeGender = "82 / Female", Phone = "(512) 555-8899", CareUnit = "Geriatrics Unit", FloorRoom = "4th Floor - 401", PrimaryDoctorName = "Dr. Anita Sharma", PrimaryDoctorSpecialty = "Pediatrics", Status = PatientStatus.InCare, RiskLevel = AlertSeverity.High, LastVisit = "May 19, 2024 11:30 AM", Avatar = "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80" },
                new Patient { PatientIdCode = "P-0007", Name = "David Wilson", Dob = "Nov 11, 1967", AgeGender = "56 / Male", Phone = "(512) 555-4455", CareUnit = "Orthopedics Unit", FloorRoom = "3rd Floor - 308", PrimaryDoctorName = "Dr. Michael Brown", PrimaryDoctorSpecialty = "Cardiology", Status = PatientStatus.InCare, RiskLevel = AlertSeverity.Low, LastVisit = "May 18, 2024 03:05 PM", Avatar = "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=150&auto=format&fit=crop&q=80" },
                new Patient { PatientIdCode = "P-0008", Name = "Barbara Taylor", Dob = "Aug 19, 1949", AgeGender = "74 / Female", Phone = "(512) 555-9988", CareUnit = "Cardiology Unit", FloorRoom = "3rd Floor - 302", PrimaryDoctorName = "Dr. James Lee", PrimaryDoctorSpecialty = "Orthopedics", Status = PatientStatus.Discharged, RiskLevel = AlertSeverity.Low, LastVisit = "May 17, 2024 10:20 AM", Avatar = "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150&auto=format&fit=crop&q=80" },
                new Patient { PatientIdCode = "P-0009", Name = "Thomas Anderson", Dob = "May 14, 1961", AgeGender = "63 / Male", Phone = "(512) 555-7711", CareUnit = "Neurology Unit", FloorRoom = "5th Floor - 502", PrimaryDoctorName = "Dr. Lisa Patel", PrimaryDoctorSpecialty = "Neurology", Status = PatientStatus.InCare, RiskLevel = AlertSeverity.Medium, LastVisit = "May 16, 2024 02:45 PM", Avatar = "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80" },
                new Patient { PatientIdCode = "P-0010", Name = "Elizabeth White", Dob = "Dec 03, 1978", AgeGender = "45 / Female", Phone = "(512) 555-3399", CareUnit = "General Ward", FloorRoom = "1st Floor - 105", PrimaryDoctorName = "Dr. Emily Clark", PrimaryDoctorSpecialty = "Endocrinology", Status = PatientStatus.Admitted, RiskLevel = AlertSeverity.Low, LastVisit = "May 15, 2024 11:00 AM", Avatar = "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&auto=format&fit=crop&q=80" }
            };
            context.Patients.AddRange(seededPatients);
            await context.SaveChangesAsync();
        }
