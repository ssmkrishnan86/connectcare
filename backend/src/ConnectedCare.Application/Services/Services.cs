...
{
    Task<List<ConsultationDto>> GetConsultationsAsync(string? tabFilter, string? statusFilter, string? typeFilter, string? patientFilter, string? unitFilter, string? search, string? doctorName);
    ...
    Task<ConsultationDto?> ScheduleFollowUpAsync(Guid id, ScheduleFollowUpDto dto);
    Task<ConsultationDto?> AddConsultationNoteAsync(Guid id, AddConsultationNoteDto dto);
    Task<ConsultationDto?> ReferSpecialistAsync(Guid id, ReferSpecialistDto dto);
    Task<List<ConsultationDto>> GetRecentConsultationsByPatientAsync(string patientIdCode);
}
...
{
    Task<List<CarePlanDto>> GetCarePlansAsync(string? tabFilter, string? statusFilter, string? unitFilter, string? patientFilter, string? conditionFilter, string? search, string? doctorName);
    ...
    Task<CarePlanDto?> UpdateCarePlanAsync(Guid id, UpdateCarePlanDto dto);
    Task<bool> DeleteCarePlanAsync(Guid id);
    Task<CarePlanDto?> AddNoteAsync(Guid id, AddCarePlanNoteDto dto);
    Task<CarePlanDto?> ReviewCarePlanAsync(Guid id, ReviewCarePlanDto dto);
}
