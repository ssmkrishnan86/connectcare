...
Generated By: ${report?.generatedByName || 'Emma Johnson'} (${report?.generatedByRole || 'Staff Nurse'})
Generated On: ${report?.generatedOnText || new Date().toLocaleString()}
Care Unit: ${report?.careUnit || 'Cardiology Unit'}
Patient: ${report?.patientName || 'All Patients'}
Shift: ${report?.shift || 'Day Shift'}
...
- Total Evaluated Records: 156
- Compliance Rate: 98.4%
- Safety Verification: Cleared & Approved
...
==================================================`;
  ...
  const handleQuickReport = (shortcutLabel: string) => {
    ...
    const reportObj = found || {
      ...
      generatedByName: 'Emma Johnson',
      generatedByRole: 'Staff Nurse',
      generatedOnText: 'May 22, 2024 10:30 AM',
      format: 'PDF',
      careUnit: 'Cardiology Unit',
      patientName: 'Patricia Smith (PT-10001)',
      shift: 'Day Shift'
    };
          ...
          <div className="bg-white rounded-2xl border border-slate-200/80 p-4 shadow-xs space-y-4">
            ...
            <div className="flex items-center justify-center relative my-2">
              <svg className="w-36 h-36 transform -rotate-90" viewBox="0 0 36 36">
                ...
                {/* Patient Reports (56%) */}
                <path className="text-blue-500 cursor-pointer hover:opacity-80 transition-opacity" onClick={() => setActiveTab('Patient Reports')} strokeWidth="4" strokeDasharray="56, 100" stroke="currentColor" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                {/* Clinical Reports (28%) */}
                <path className="text-purple-500 cursor-pointer hover:opacity-80 transition-opacity" onClick={() => setActiveTab('Clinical Reports')} strokeWidth="4" strokeDasharray="28, 100" strokeDashoffset="-56" stroke="currentColor" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                {/* Medication Reports (9%) */}
                <path className="text-amber-500 cursor-pointer hover:opacity-80 transition-opacity" onClick={() => setActiveTab('Medication Reports')} strokeWidth="4" strokeDasharray="9, 100" strokeDashoffset="-84" stroke="currentColor" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                {/* Operational Reports (6%) */}
                <path className="text-teal-500 cursor-pointer hover:opacity-80 transition-opacity" onClick={() => setActiveTab('Operational Reports')} strokeWidth="4" strokeDasharray="6, 100" strokeDashoffset="-93" stroke="currentColor" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
              </svg>
            ...
            <div className="p-6 space-y-5 overflow-y-auto flex-1 text-xs">
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 bg-slate-50 p-4 rounded-xl border border-slate-100">
                <div>
                  ...
                  <p className="font-extrabold text-slate-800">{selectedReport.generatedByName || 'Emma Johnson'}</p>
                  <p className="text-[10px] text-slate-500 font-semibold">{selectedReport.generatedByRole || 'Staff Nurse'}</p>
                </div>
                <div>
                  <span className="text-[10px] font-bold text-slate-400 uppercase">Generated On</span>
                  <p className="font-extrabold text-slate-800">{selectedReport.generatedOnText || 'May 22, 2024'}</p>
                </div>
                <div>
                  <span className="text-[10px] font-bold text-slate-400 uppercase">Unit / Location</span>
                  <p className="font-extrabold text-slate-800">{selectedReport.careUnit || 'Cardiology Unit'}</p>
                </div>
              </div>
