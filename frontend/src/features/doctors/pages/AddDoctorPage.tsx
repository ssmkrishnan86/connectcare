...
export const AddDoctorPage: React.FC = () => {
  ...
  const validateStep = (step: number): boolean => {
    ...
    if (step === 3 || step === 5) {
      if (!licenseNumber.trim()) errors.licenseNumber = 'Medical license number is required.';
      if (!experienceYears.trim()) errors.experienceYears = 'Clinical experience is required.';
    }
