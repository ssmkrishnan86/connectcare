...
export const Sidebar: React.FC = () => {
  ...
  // Default Admin Nav Groups (unchanged for Admin)
    ...
    <aside className="w-64 bg-[#0B132B] text-slate-300 flex flex-col h-screen sticky top-0 border-r border-slate-800 z-30 select-none font-sans">
      ...
      <div className="p-4 flex items-center gap-3 border-b border-slate-800/80 shrink-0">
        ...
        <div>
          ...
          <p className="text-[11px] font-bold text-indigo-400">{portalTitle}</p>
        </div>
      </div>
                  ...
                  >
                    ...
                    {item.badge && (
                      <Badge
                        ...
                        className={item.badgeVariant === 'critical' ? 'bg-rose-500 text-white border-none px-2 text-[10px]' : ''}
                      >
                        {item.badge}
                      </Badge>
                    )}
      ...
      {/* User Footer Profile */}
      <div className="p-3 m-3 bg-slate-900/90 rounded-2xl border border-slate-800 flex items-center justify-between shrink-0">
        <div className="flex items-center gap-2.5 overflow-hidden">
          <div className="h-9 w-9 rounded-full bg-indigo-500/20 border border-indigo-500/40 text-indigo-300 flex items-center justify-center font-bold text-xs shrink-0">
