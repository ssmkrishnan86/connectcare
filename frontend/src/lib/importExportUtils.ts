...
export const MODULE_CONFIGS: Record<string, ModuleImportExportConfig> = {
  ...
  patients: {
    ...
    columns: [
      ...
      { key: 'insuranceProvider', label: 'Insurance Provider', required: true, description: 'Health insurance provider / payer', sampleValue: 'Blue Cross Blue Shield' },
      { key: 'insurancePolicyNumber', label: 'Policy Number', required: true, description: 'Insurance policy or member identification number', sampleValue: 'POL-9928114' },
      { key: 'insuranceGroupNumber', label: 'Group Number', required: false, description: 'Insurance group identification number', sampleValue: 'GRP-45678' },
      { key: 'insuranceValidUntil', label: 'Insurance Valid Until', required: false, description: 'YYYY-MM-DD', sampleValue: '2028-12-31' },
    ...
    sampleData: [
      {
        ...
        insurancePolicyNumber: 'POL-9928114',
        insuranceGroupNumber: 'GRP-45678',
      ...
      },
      {
        ...
        insurancePolicyNumber: 'POL-3321901',
        insuranceGroupNumber: 'GRP-99881',
    ...
    mapRowToEntity: (row) => ({
      ...
      insuranceProvider: row.insuranceProvider || 'Blue Cross Blue Shield',
      insurancePolicyNumber: row.insurancePolicyNumber || `POL-${Math.floor(100000 + Math.random() * 900000)}`,
